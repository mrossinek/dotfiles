...
imap [ <C-o><Plug>PairBraceOpen
imap ] <C-o><Plug>PairBraceClose
imap { <C-o><Plug>PairBracketOpen
imap } <C-o><Plug>PairBracketClose
imap < <C-o><Plug>PairAngleOpen
imap > <C-o><Plug>PairAngleClose
imap ' <C-o><Plug>PairQuoteSingle
imap " <C-o><Plug>PairQuoteDouble
imap ` <C-o><Plug>PairBacktick
